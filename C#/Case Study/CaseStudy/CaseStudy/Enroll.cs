...
namespace CaseStudy
{
    ...
    class InMemoryAppEngine : AppEngine
    {
        ...
        public List<EnrollExample> ListOfEnrollments()
        {
            StudentDB student = new StudentDB(1, "Prateek", Convert.ToDateTime("14/01/1999"));
            StudentDB student1 = new StudentDB(2, "Kapil", Convert.ToDateTime("19/05/1999"));
            StudentDB student2 = new StudentDB(3, "Shreya", Convert.ToDateTime("15/06/1999"));
    ...
    internal class Enroll
    {
        static void Main()
        {
            ...
            appengine.Register(new StudentDB(101, "Prateek", Convert.ToDateTime("14/01/1999")));
            Console.WriteLine("-----------------------------------------");
            ...
            Console.WriteLine("-----------------------------------------");
            appengine.Enroll(new StudentDB(101, "Prateek", Convert.ToDateTime("14/01/1999")), new Courses(1002, "Python", "6Months", 3000));
            Console.WriteLine("-----------------------------------------");

...
namespace CaseStudy
{
    class StudentDB
    {
        ...
        internal static string collegeName = "MITS";
    ...
    class App
    {
        ...
        {
            StudentDB student1 = new StudentDB(1, "Prateek", Convert.ToDateTime("14/01/1999"));
            StudentDB student2 = new StudentDB(2, "Kapil", Convert.ToDateTime("19/05/1999"));
            StudentDB student3 = new StudentDB(3, "Shreya", Convert.ToDateTime("15/06/1999"));
        ...
        public static void Scenario2()
        {
            ...
            students[0] = new StudentDB(1, "Prateek", Convert.ToDateTime("14/01/1999"));
            students[1] = new StudentDB(2, "Kapil", Convert.ToDateTime("19/05/1999"));
            students[2] = new StudentDB(3, "Shreya", Convert.ToDateTime("15/06/1999"));

...
namespace CaseStudy
{
    ...
    internal class Enroll
    {
        static void Main()
        {
            ...
            appengine.Register(new StudentDB(101, "Yashvi", Convert.ToDateTime("14/01/1999")));
            Console.WriteLine("-----------------------------------------");
            ...
            Console.WriteLine("-----------------------------------------");
            appengine.Enroll(new StudentDB(101, "Yashvi", Convert.ToDateTime("14/01/1999")), new Courses(1002, "Python", "6Months", 3000));
            Console.WriteLine("-----------------------------------------");
